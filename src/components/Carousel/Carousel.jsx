...
<div id="carouselBasicExample" className="carousel slide carousel-fade" data-mdb-ride="carousel">
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src={images.image1} className="d-block w-100" alt="Sunset Over the City"/>
    ...
    <div className="carousel-item">
      <img src={images.image2} className="d-block w-100" alt="Canyon at Nigh"/>
      <div className="carousel-caption d-none d-md-block">
    ...
    <div className="carousel-item">
      <img src={images.image3} className="d-block w-100" alt="Cliff Above a Stormy Sea"/>
      <div className="carousel-caption d-none d-md-block">
